...
public class SMenuAdapter extends RecyclerView.Adapter<SMenuAdapter.MyViewHolder> {
    ...
    public SMenuAdapter(ArrayList<BDataModel> data){
        this.dataModels = data;
    }

    @NonNull
    @Override
    public SMenuAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull SMenuAdapter.MyViewHolder holder, int position) {
        ...
        FoodItem.setText("Snacks id: "+dataModels.get(position).getFoodItem());
